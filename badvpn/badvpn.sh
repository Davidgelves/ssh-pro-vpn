...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/Davidgelves/sshpro-main/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/Davidgelves/sshpro-main/main/badvpn/antcrashvpn.sh -o /dev/null
