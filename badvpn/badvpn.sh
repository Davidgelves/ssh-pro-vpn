...
fun_udp1 () {
    ...
    menu
	    ...
	    inst_udp () {
            ...
            wget https://raw.githubusercontent.com/Davidgelves/ssh-pro-vpn/main/badvpn/badvpn-udpgw -o /dev/null
			wget https://raw.githubusercontent.com/Davidgelves/ssh-pro-vpn/main/badvpn/antcrashvpn.sh -o /dev/null
